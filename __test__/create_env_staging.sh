...
cp $tmp_dir/.env.staging.local $tmp_dir/packages/api/.env
cp $tmp_dir/.env.staging.local $tmp_dir/packages/react/.env
...
cat $tmp_dir/.env.staging.local | sed 's/SCENE_ID/NEXT_PUBLIC_SCENE_ID/g' | sed 's/REFLCT_API_KEY/NEXT_PUBLIC_REFLCT_API_KEY/g' > $env_dir/next-test/.env
...
cat $tmp_dir/.env.staging.local | sed 's/SCENE_ID/VITE_SCENE_ID/g' | sed 's/REFLCT_API_KEY/VITE_API_KEY/g' > $env_dir/vite-test/.env
